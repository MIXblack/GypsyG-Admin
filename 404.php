...
<html lang="en">
    <head>
        ...
        <!--title-->
        <title>404 | Fun Ludo</title>

        <!--favicon icon-->
        <link rel="icon" href="home-assets/img/logo/favicon.ico" type="image/png" sizes="16x16">
        ...
        <!--ytplayer css-->
        <link rel="stylesheet" href="home-assets/css/jquery.mb.YTPlayer.min.css">

        <!--Owl carousel css-->
        <link rel="stylesheet" href="home-assets/css/owl.carousel.min.css">
        <link rel="stylesheet" href="home-assets/css/owl.theme.default.min.css">

        <!--custom css-->
        <link rel="stylesheet" href="home-assets/css/mix-custom.css">
    ...
    <body>
        ...
        <div class="main">
            ...
            <section class="hero-section ptb-100 background-img full-screen"
                    style="background: url('home-assets/img/background/app-hero-bg.jpg')no-repeat center center / cover">
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-9 col-lg-7">
                            <div class="error-content text-center text-white">
                                ...
                                <a class="btn app-store-btn" href="index.php">Go to Homepage</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!--jQuery-->
        <script src="home-assets/js/jquery-3.5.0.min.js"></script>
        ...
        <!--jquery ytplayer js-->
        <script src="home-assets/js/jquery.mb.YTPlayer.min.js"></script>
